...
int main()
{
	...
	if (MessageBoxW(NULL, L"WARNING!!!\r\n\You're about to run malware named CoreR (noskid)\r\n\It doesn't delete all your data", L"CoreR (noskid)", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
	{
		ExitProcess(0);
	}
	else
	{
		if (MessageBoxW(NULL, L"F̷i̷n̸a̴l̴ ̴W̸a̴r̸n̷i̸n̷g̷ !!!\r\n\You're about to run malware named CoreR\r\n\It doesn't delete all your data\r\n\NOT FOR EPILEPSY", L"F̷i̷n̸a̴l̴ ̴W̸a̴r̸n̷i̸n̷g̷ - CoreR (again, noskid)", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
		{
			ExitProcess(0);
		}
		else
